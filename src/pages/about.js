                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium text-main'> Hi 我是Hank，一位想透過網頁讓人類世界更美好的前端工程師，致力於不斷精進自己的技能和知識。
                                ...
                                有2年半經驗在前端領域，目前開始看後端以及更艱深低層的JS以及React.js框架，
                                走在前端的潮流浪頭，使用網頁技術讓我的客戶到商業和生活上。
                            </p>
                            <p className='my-4 font-medium text-main'>我相信平時不斷精進自己的code和技術，目的是為了提供給更好的體驗給使用者。
                                目前，我正專注於學習 Next.js 和後端相關的技術。Next.js 是一個優秀的 React 框架，能夠幫助我們快速構建高性能、可擴展的網頁應用程式。我對於 Next.js 的服務端渲染、靜態生成和路由配置等功能有著深入的研究和實踐。
                                同時，我也積極學習後端技術，包括 Node.js、Express 和資料庫等，以便更好地理解和協作於整個開發流程中的後端需求。
                            </p>
                            <p className='font-medium text-main'>
                                在過去的工作經驗中，我經常參與與設計師、後端工程師和產品經理的密切合作。我深信良好的團隊協作能夠將最佳的用戶體驗呈現給使用者。我具備良好的溝通能力和解決問題的技巧，能夠有效地與團隊成員溝通並解決技術上的挑戰。
                                我也積極參與代碼審查和測試等活動，以確保高質量的代碼交付。
