    ...
    return (
        <figure className='absolute left-0 stroke-dark dark:stroke-light'>
            <svg className='-rotate-90 md:w-[60px] md:h-[60px] xs:w-[40px] xs:h-[40px]' height='75' viewBox='0 0 100 100'>
                <circle cx='75' cy='50' r='20' className='stroke-main stroke-1 fill-none dark:stroke-main' />
                <motion.circle cx='75' cy='50' r='20' className='stroke-[5px] fill-light dark:fill-dark'
                    style={{
                        pathLength: scrollYProgress,

                    }} />
                <circle cx='75' cy='50' r='10' className='animate-pulse stroke-1 fill-main dark:fill-main' />
            </svg>
        </figure>
    )
}
